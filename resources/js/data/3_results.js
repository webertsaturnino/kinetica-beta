    ...
    var config = {
        ...
        data: {
            ...
            },
            {
                ...
                data: chart_data_linear_exponential,
                borderColor: "rgb(85, 62, 035)",
                backgroundColor: "rgb(85, 62, 035)",
                fill: false,
                showLine: true
            },{
                label: 'Linear + Reciprocal Exponential',
                data: chart_data_linear_reciprocal_exponential,
                borderColor: "rgb(254, 222, 035)",
                backgroundColor: "rgb(254, 222, 035)",
                fill: false,
                showLine: true
        ...
        options: {
            ...
            scales: {
                xAxes: [{
                    ...
                    scaleLabel: {
                        display: true,
                        labelString: 'Concentration (' + label_x + ')'
                    },
                    ticks: {
                        suggestedMin: 0,
                        suggestedMax: max_x,
